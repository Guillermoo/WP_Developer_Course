    ...
    while($profPost->have_posts()){
        ...
        ob_start();?>
         ...
         <div class="professor-callout">
             <div class="professor-callout__photo" style="background-image: url(<?php echo the_post_thumbnail_url('professorPortrait') ?>)"></div>
             <div class="professor-callout__text">
                 ...
                 <?php 
                    ...
                    if ($relatedPrograms) {?>
                        <!-- Se podría usar un esc_html, pero en este caso lo dejamos así -->
                        <p><?php the_title() ?> teaches:
                        <?php foreach ($relatedPrograms as $key => $program) {
                            echo get_the_title($program);
                            // Para ver si no es el último artíuclo
